"""
Django settings for Veacon project.
...
INSTALLED_APPS = [
    ...
    'user_veacon.apps.UserVeaconConfig',
    'gateway_beacon',
    'beacon',
    'vehicle',
    'watchpost',
...
STATIC_URL = '/static_sys/'

if not DEBUG:
    STATIC_ROOT = os.path.join(BASE_DIR, 'static_sys')
